...
Los Museos en la actualidad están explorando las nuevas tecnologías digitales y móviles para mejorar la experiencia del visitante. Iniciativas van más allá de la tecnología dentro de exposiciones e instalaciones , pero también incluyen usos más generalizados de la tecnología para crear experiencias interactivas para los visitantes a lo largo de un museo , así como experiencias a distancia para los que no pueden llegar hasta allí.
...
\begin{figure}
	\centering
		\includegraphics{C:/Users/francisco/Dropbox/tesis doc/art kinect/journal kinect/images/frenteexhi.PNG}
		\label{fig:Figure 1}
	Fig 1. Front display.
\end{figure}
